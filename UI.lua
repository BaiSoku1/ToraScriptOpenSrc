...
local function createOptionHolder(holderTitle, parent, parentTable, subHolder)
	...
	parentTable.main = library:Create("ImageButton", {
		...
		ImageColor3 = Color3.fromRGB(240, 240, 240), -- Putih abu-abu terang
	...
	if not subHolder then
		round = library:Create("ImageLabel", {
			...
			BackgroundTransparency = 1,
			Image = "rbxassetid://3570695787",
			ImageColor3 = parentTable.open and (subHolder and Color3.fromRGB(240, 240, 240) or Color3.fromRGB(245, 245, 245)) or (subHolder and Color3.fromRGB(250, 250, 250) or Color3.fromRGB(255, 255, 255)),
			ScaleType = Enum.ScaleType.Slice,
			SliceCenter = Rect.new(100, 100, 100, 100),
			SliceScale = 0.04,
	...
	local title = library:Create("TextLabel", {
		...
		BackgroundColor3 = Color3.fromRGB(245, 245, 245), -- Putih terang
		BorderSizePixel = 0,
		Text = holderTitle,
		TextSize = subHolder and 16 or 17,
		Font = Enum.Font.LuckiestGuy,
		TextColor3 = Color3.fromRGB(40, 40, 40), -- Abu-abu gelap untuk teks
		Parent = parentTable.main
	})
	...
	local close = library:Create("ImageLabel", {
		...
		ImageColor3 = parentTable.open and Color3.fromRGB(120, 120, 120) or Color3.fromRGB(160, 160, 160),
	...
	closeHolder.InputBegan:connect(function(input)
		if input.UserInputType == ui then
			...
			tweenService:Create(close, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Rotation = parentTable.open and 90 or 180, ImageColor3 = parentTable.open and Color3.fromRGB(120, 120, 120) or Color3.fromRGB(160, 160, 160)}):Play()
			if subHolder then
				tweenService:Create(title, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = parentTable.open and Color3.fromRGB(240, 240, 240) or Color3.fromRGB(245, 245, 245)}):Play()
			else
				tweenService:Create(round, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = parentTable.open and Color3.fromRGB(245, 245, 245) or Color3.fromRGB(255, 255, 255)}):Play()
			end
...
local function createLabel(option, parent)
	local main = library:Create("TextLabel", {
		...
		TextColor3 = Color3.fromRGB(60, 60, 60), -- Abu-abu gelap
...
function createToggle(option, parent)
	local main = library:Create("TextLabel", {
		...
		TextSize = 17,
		Font = Enum.Font.GothamBlack,
		TextColor3 = Color3.fromRGB(40, 40, 40), -- Abu-abu gelap
		TextXAlignment = Enum.TextXAlignment.Left,
		Parent = parent.content
	})
	...
	local tickboxOutline = library:Create("ImageLabel", {
		...
		BackgroundTransparency = 1,
		Image = "rbxassetid://3570695787",
		ImageColor3 = option.state and Color3.fromRGB(255, 65, 65) or Color3.fromRGB(180, 180, 180),
		ScaleType = Enum.ScaleType.Slice,
		SliceCenter = Rect.new(100, 100, 100, 100),
		SliceScale = 0.02,
		Parent = main
	...
	local tickboxInner = library:Create("ImageLabel", {
		...
		BackgroundTransparency = 1,
		Image = "rbxassetid://3570695787",
		ImageColor3 = option.state and Color3.fromRGB(255, 65, 65) or Color3.fromRGB(235, 235, 235),
		ScaleType = Enum.ScaleType.Slice,
		SliceCenter = Rect.new(100, 100, 100, 100),
		SliceScale = 0.02,
	...
	main.InputEnded:connect(function(input)
		if input.UserInputType == Enum.UserInputType.MouseMovement then
			inContact = true
			if not option.state then
				tweenService:Create(tickboxOutline, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(180, 180, 180)}):Play()
			end
		end
	end)
	...
	function option:SetState(state)
		...
		tweenService:Create(tickboxInner, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = state and Color3.fromRGB(255, 65, 65) or Color3.fromRGB(235, 235, 235)}):Play()
		if state then
...
function createButton(option, parent)
	...
	main.InputBegan:connect(function(input)
		...
		if input.UserInputType == Enum.UserInputType.MouseMovement then
			inContact = true
			tweenService:Create(round, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(200, 200, 200)}):Play()
		end
	end)
	...
	main.InputEnded:connect(function(input)
		if input.UserInputType == ui then
			clicking = false
			if inContact then
				tweenService:Create(round, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(200, 200, 200)}):Play()
			else
				tweenService:Create(round, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(220, 220, 220)}):Play()
			end
		elseif input.UserInputType == Enum.UserInputType.Touch then
			clicking = false
			if inContact then
		...
		if input.UserInputType == Enum.UserInputType.MouseMovement then
			...
			if not clicking then
				tweenService:Create(round, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(220, 220, 220)}):Play()
			end
		end
	end)
end
...
local function createBind(option, parent)
	...
	function option:SetKey(key)
		...
		tweenService:Create(round, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = inContact and Color3.fromRGB(200, 200, 200) or Color3.fromRGB(220, 220, 220)}):Play()
...
local function createSlider(option, parent)
	...
	main.InputBegan:connect(function(input)
		...
		if input.UserInputType == Enum.UserInputType.MouseMovement then
			inContact = true
			if not sliding then
				tweenService:Create(fill, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(140, 140, 140)}):Play()
				tweenService:Create(circle, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Size = UDim2.new(2.8, 0, 2.8, 0), ImageColor3 = Color3.fromRGB(140, 140, 140)}):Play()
			end
		end
	end)
	...
	main.InputEnded:connect(function(input)
		if input.UserInputType == ui then
			...
			if inContact then
				...
				tweenService:Create(fill, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(180, 180, 180)}):Play()
				tweenService:Create(circle, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Size = UDim2.new(0, 0, 0, 0), ImageColor3 = Color3.fromRGB(180, 180, 180)}):Play()
			end
		elseif input.UserInputType == Enum.UserInputType.Touch then
			sliding = false
			if inContact then
...
local function createList(option, parent, holder)
	...
	function option:AddValue(value)
		...
		label.InputBegan:connect(function(input)
			if input.UserInputType == ui then
				clicking = true
				tweenService:Create(label, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(220, 220, 220)}):Play()
				self:SetValue(value)
			elseif input.UserInputType == Enum.UserInputType.Touch then
				clicking = true
				tweenService:Create(label, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(220, 220, 220)}):Play()
			...
			if input.UserInputType == Enum.UserInputType.MouseMovement then
				inContact = true
				if not clicking then
					tweenService:Create(label, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(225, 225, 225)}):Play()
				end
			end
		end)
		...
		label.InputEnded:connect(function(input)
			if input.UserInputType == ui then
				clicking = false
				tweenService:Create(label, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = inContact and Color3.fromRGB(225, 225, 225) or Color3.fromRGB(240, 240, 240)}):Play()
			elseif input.UserInputType == Enum.UserInputType.Touch then
				clicking = false
				tweenService:Create(label, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = inContact and Color3.fromRGB(225, 225, 225) or Color3.fromRGB(240, 240, 240)}):Play()
			end
			if input.UserInputType == Enum.UserInputType.MouseMovement then
				inContact = false
				if not clicking then
					tweenService:Create(label, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(240, 240, 240)}):Play()
				end
			end
		end)
	end
...
local function createBox(option, parent)
	...
	main.InputBegan:connect(function(input)
		...
		if input.UserInputType == Enum.UserInputType.MouseMovement then
			inContact = true
			if not focused then
				tweenService:Create(outline, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(140, 140, 140)}):Play()
			end
		end
	end)
	...
	main.InputEnded:connect(function(input)
		if input.UserInputType == Enum.UserInputType.MouseMovement then
			inContact = false
			if not focused then
				tweenService:Create(outline, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(180, 180, 180)}):Play()
			end
		end
	end)
	...
	inputvalue.FocusLost:connect(function(enter)
		focused = false
		tweenService:Create(outline, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(180, 180, 180)}):Play()
...
local function createColorPickerWindow(option)
	...
	option.resetColor.InputBegan:connect(function(Input)
		...
		if Input.UserInputType == Enum.UserInputType.MouseMovement and not dragging then
			tweenService:Create(option.resetColor, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(220, 220, 220)}):Play()
		end
	end)
	
	option.resetColor.InputEnded:connect(function(Input)
		if Input.UserInputType == Enum.UserInputType.MouseMovement and not dragging then
			tweenService:Create(option.resetColor, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(235, 235, 235)}):Play()
		end
	end)
	...
	option.undoColor.InputBegan:connect(function(Input)
		...
		if Input.UserInputType == Enum.UserInputType.MouseMovement and not dragging then
			tweenService:Create(option.undoColor, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(220, 220, 220)}):Play()
		end
	end)
	
	option.undoColor.InputEnded:connect(function(Input)
		if Input.UserInputType == Enum.UserInputType.MouseMovement and not dragging then
			tweenService:Create(option.undoColor, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(235, 235, 235)}):Play()
		end
	end)
	...
	option.setColor.InputBegan:connect(function(Input)
		...
		if Input.UserInputType == Enum.UserInputType.MouseMovement and not dragging then
			tweenService:Create(option.setColor, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(220, 220, 220)}):Play()
		end
	end)
	
	option.setColor.InputEnded:connect(function(Input)
		if Input.UserInputType == Enum.UserInputType.MouseMovement and not dragging then
			tweenService:Create(option.setColor, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(235, 235, 235)}):Play()
		end
	end)
	...
	option.rainbow.InputBegan:connect(function(Input)
		if Input.UserInputType == ui then
			...
			if rainbowEnabled then
				...
				option.rainbowText.TextColor3 = Color3.fromRGB(40, 40, 40)
			end
		elseif input.UserInputType == Enum.UserInputType.Touch then
			rainbowEnabled = not rainbowEnabled
			if rainbowEnabled then
		...
		if Input.UserInputType == Enum.UserInputType.MouseMovement and not dragging then
			tweenService:Create(option.rainbow, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(220, 220, 220)}):Play()
		end
	end)
	
	option.rainbow.InputEnded:connect(function(Input)
		if Input.UserInputType == Enum.UserInputType.MouseMovement and not dragging then
			tweenService:Create(option.rainbow, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(235, 235, 235)}):Play()
		end
	end)
...
local function createColor(option, parent, holder)
	...
	option.main.InputEnded:connect(function(input)
		if input.UserInputType == Enum.UserInputType.MouseMovement then
			inContact = true
			if not option.open then
				tweenService:Create(colorBoxOutline, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(180, 180, 180)}):Play()
			end
		end
	end)
